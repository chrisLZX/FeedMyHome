...
function hideElement(){document.getElementById("SilentIcon").style.display='none';document.getElementById("CalendarIcon").style.display='none';document.getElementById("MMSIcon").style.display='none';document.getElementById("IMIcon").style.display='none';}
...
function chgFeed(){document.getElementById("rssIm").src='imgs/rss_link.png';updRss=0;if(idFeed==3) idFeed=0;if(idFeed<3) idFeed++;chooseFeed(idFeed);document.getElementById("feedRss").innerHTML='<img src="imgs/processing.gif"/>';updateFeed();}