...
function fetchWeatherData (callback, zip,id)
{
	...
	xml_request.onload = function(e) {xml_loaded(e, xml_request, id, callback);}
...
function xml_loaded (event, request, id, callback)
{
...
function validateWeatherLocation (location, callback,id)
{
	...
	var xml_request = new XMLHttpRequest();
	xml_request.onload = function(e) {xml_validateloaded(e, xml_request, id, callback);}
	xml_request.overrideMimeType("text/xml");
...
function xml_validateloaded (event, request, id, callback)
{
	if (request.responseXML)
	{
